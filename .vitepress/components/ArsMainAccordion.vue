...
const sections = [
  {
    ...
    content: `
<p>Начинать с главного.<br>
Искать сигнал в шуме.<br>
Создавать инструменты, а не украшения.<br>
Верить, что новая форма создает новое будущее.<br>
Выбирать партнеров, а не просто клиентов.<br>
Соединять систему и смысл.<br>
Искать причину, а не симптом.<br>
Стремиться к яростной простоте.<br>
Строить на десятилетия, а не на кварталы.<br>
Мечтать и действовать.</p>
`
  },
  {
    title: 'Свой Знак',
